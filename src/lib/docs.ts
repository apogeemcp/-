...
export const DOCS_NAV: DocsNavItem[] = [
  ...
  { group: "Start", href: "/developers/access", label: "Access" },
  ...
  { group: "Build", href: "/developers/partners", label: "Partners" },
...
export function docsSearchIndex(): SearchHit[] {
  ...
  const extras: SearchHit[] = [
    ...
    { title: "MCP access", href: "/developers/access", section: "Start", text: "auth none $ORBITX rental permanent burn not live" },
    { title: "Partners", href: "/developers/partners", section: "Build", text: "partnership AI trading wallet analytics" },
