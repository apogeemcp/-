  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[62vh]">
        <Image src="/brand/banner.png?v=4" alt="" fill className="object-cover object-[center_20%]" priority />
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col justify-end px-5 pb-24 pt-28">
        ...
        <p className="mt-5 max-w-xl text-lg text-ivory/75">
          Robinhood Chain intel for agents — 3000 tools. Search. Chart. Desk. Launch. Track. Live MCP at{" "}
          <span className="font-mono text-gold">apogeemcp.digital/api/mcp</span>. Connect Phantom, chat a pons launch,
          add to Cursor / Claude / GPT / Grok in one click.
        </p>
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Link href="/wallet" className="rounded-full border border-ivory/20 px-6 py-3 text-sm uppercase tracking-[0.18em] text-ivory/80">
            Track wallet
          </Link>
        </div>
        <div className="mt-14 grid gap-3 sm:grid-cols-5">
          {[
            ...
            ["Launch", "pons v2 via Phantom."],
            ["Track", "Wallet PnL & flow."],
          ].map(([p, d]) => (
