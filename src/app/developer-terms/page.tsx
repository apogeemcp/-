  ...
  return (
    <LegalDoc
      ...
      body={[
        ...
        `Paid access. Official USD list prices are published at /developers/access. Pay by sending SOL or USDC on Solana to the published treasury, then submit the Solscan transaction URL. Access is recorded after that payment is verified. A 25% $ORBITX buy-and-burn is executed manually afterwards and is not part of your payment transaction. Do not pay any other address. This software does not issue API keys.`,
