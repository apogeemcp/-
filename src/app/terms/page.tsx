  ...
  return (
    <LegalDoc
      ...
      body={[
        ...
        `MCP services. The MCP server at ${mcp} (alias /mcp) uses Streamable HTTP JSON-RPC, protocol 2025-03-26, authentication none. Optional paid MCP grants are sold at /developers/access by sending SOL or USDC to the published Solana treasury and confirming with a Solscan transaction link. $ORBITX buy-and-burn is executed manually after payment. Do not pay any other address or anyone selling Apogee MCP API keys — this software does not issue those credentials. See also /developer-terms.`,
