  ...
  return (
    <LegalDoc
      ...
      body={[
        ...
        `MCP services. The MCP server at ${mcp} (alias /mcp) uses Streamable HTTP JSON-RPC, protocol 2025-03-26, authentication none. MCP is a technical protocol. Obligations depend on functionality, data, jurisdictions, and how you operate a product that calls Apogee — not on MCP itself.`,
        ...
        `Account responsibilities. Apogee does not create user accounts. If you connect a wallet, you remain solely responsible for that wallet.`,
