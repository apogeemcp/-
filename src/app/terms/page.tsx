  ...
  return (
    <LegalDoc
      ...
      body={[
        ...
        `MCP services. The MCP server at ${mcp} (alias /mcp) uses Streamable HTTP JSON-RPC, protocol 2025-03-26, authentication none. MCP is a technical protocol. Obligations depend on functionality, data, jurisdictions, and how you operate a product that calls Apogee — not on MCP itself. Token-gated or paid MCP access is not enabled. Do not pay third parties claiming to sell Apogee MCP keys or burns; this software does not issue those credentials.`,
